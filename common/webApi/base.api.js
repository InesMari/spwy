...
// 登录
const login = params => req.postByCode('500069', params);   //微信登录
...
const codeLogin = params => req.postByCode('500070', params);   //手机验证码登录
const checkSmsCode = params => req.postByCode('500055', params);   //判断手机验证码是否正确
const getUserRegion = params => req.postByCode('500076',params);//获取用户关联区域
const selectOrg = params => req.postByCode('500077',params);//切换区域
...
const getRegion = params => req.postByCode('500071', params,undefined,undefined,true); //获取区域数据
...
const orderList = params => req.postByCode('500075', params);   //订单列表(首页)
